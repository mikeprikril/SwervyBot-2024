...
public final class Constants {
    ...
    public static final double ROBOT_MASS = (40) * 0.453592; // 40lbs * kg per pound - update as we build robot + bumpers
    public static final double MANIPULATOR_MASS = 20 * 0.453592; // 20 bs * kg per pound
    ...
    public static final Translation3d CHASSIS_CG = new Translation3d(
        0,
        0,
        Units.inchesToMeters(8)); //assuing Center of Gravity is right at robot centroid and 8" above ground
    ...
    public static final class Drivebase {
        ...
        public static final double FRONT_LEFT_X = Units.inchesToMeters(11.88);
        public static final double FRONT_LEFT_Y = Units.inchesToMeters(11.88);
        public static final double FRONT_RIGHT_X = Units.inchesToMeters(11.88);
        public static final double FRONT_RIGHT_Y = Units.inchesToMeters(-11.88);
        public static final double BACK_LEFT_X = Units.inchesToMeters(-11.88);
        public static final double BACK_LEFT_Y = Units.inchesToMeters(11.88);
        public static final double BACK_RIGHT_X = Units.inchesToMeters(-11.88);
        public static final double BACK_RIGHT_Y = Units.inchesToMeters(-11.88);
        ...
        public static final double VELOCITY_KP = 0.0020645; // kp needs to be determined
        ...
        public static final class Mod0 {
            ...
            public static final double ANGLE_OFFSET = 1.4;
        ...
        public static final class Mod1 {
            ...
            public static final double ANGLE_OFFSET = 39.9;
            public static final SwerveModuleConstants CONSTANTS =
                new SwerveModuleConstants(DRIVE_MOTOR_ID, ANGLE_MOTOR_ID, CANCODER_ID, ANGLE_OFFSET);
        }
        public static final class Mod2 {
            ...
            public static final double ANGLE_OFFSET = 177.3;
            public static final SwerveModuleConstants CONSTANTS =
                new SwerveModuleConstants(DRIVE_MOTOR_ID, ANGLE_MOTOR_ID, CANCODER_ID, ANGLE_OFFSET);
        }
        public static final class Mod3 {
            ...
            public static final double ANGLE_OFFSET = 78.6;
            public static final SwerveModuleConstants CONSTANTS =
                new SwerveModuleConstants(DRIVE_MOTOR_ID, ANGLE_MOTOR_ID, CANCODER_ID, ANGLE_OFFSET);
        }
