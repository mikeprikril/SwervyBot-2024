...
public class SwerveModule {
    ...
    public SwerveModule(int moduleNumber, SwerveModuleConstants moduleConstants) {
        ...
        canCoderConfiguration.MagnetSensor.SensorDirection = Drivebase.CANCODER_INVERT ? SensorDirectionValue.CounterClockwise_Positive : SensorDirectionValue.Clockwise_Positive;
        CANcoderConfigurator canCoderConfigurator = absoluteEncoder.getConfigurator();
        ...
        angleEncoder.setPosition((absoluteEncoder.getAbsolutePosition().getValueAsDouble() * 360) - angleOffset);
