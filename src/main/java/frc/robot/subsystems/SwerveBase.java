  ...
  */
  public SwerveBase() {
    ...
    if (!Robot.isReal()) {
      ...
      configurator.apply(new Pigeon2Configuration());
    }
  ...
  public Rotation2d getYaw() {
    ...
    if (Robot.isReal()) {
      return (Drivebase.INVERT_GYRO) ? Rotation2d.fromDegrees(360 - imu.getYaw().getValueAsDouble()) : Rotation2d.fromDegrees(imu.getYaw().getValueAsDouble());
    } else {
